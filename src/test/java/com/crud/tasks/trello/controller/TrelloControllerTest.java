...
public class TrelloControllerTest {
    ...
    public void testShouldFetchTrelloBoards() throws Exception {
        ...
        trelloLists.add(new TrelloListDto("01", "Test List", false));

        List<TrelloBoardDto> trelloBoards = new ArrayList<>();
        trelloBoards.add(new TrelloBoardDto("Test Board", "01", trelloLists));
        ...
        mockMvc.perform(get("/v1/trello/getTrelloBoards").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].id", is("01")))
                .andExpect(jsonPath("$[0].name", is("Test Board")))
                //Trello list fields
                .andExpect(jsonPath("$[0].lists", hasSize(1)))
                .andExpect(jsonPath("$[0].lists[0].id", is("01")))
    ...
    public void testShouldCreateTrelloCard() throws Exception {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test", "Test description", "top", "01");
