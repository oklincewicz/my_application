...
public class TrelloFacadeTest {
    ...
    public void shouldFetchEmptyList() {
        ...
        when(trelloValidator.validatorTrelloBoard(mappedTrelloBoards)).thenReturn(new ArrayList<>());
    ...
    public void shouldFetchTrelloBoards() {
        ...
        when(trelloValidator.validatorTrelloBoard(mappedTrelloBoards)).thenReturn(mappedTrelloBoards);
